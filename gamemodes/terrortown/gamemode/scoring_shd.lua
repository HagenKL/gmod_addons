...
function KillsToPoints(score, was_traitor, was_jackal)
   local points = ((score.suicides * -1) + score.bonus + (score.traitors * (was_traitor and -16 or was_jackal and 3 or 5)) + (score.innos * (was_traitor and 1 or was_jackal and 2 or -8)) + (score.deaths == 0 and 1 or 0))
