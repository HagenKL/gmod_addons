...
Event(EVENT_KILL,
      { text = KillText,
        icon = function(e)
                  ...
                  if (e.att.tr and e.vic.tr) or (e.att.sv and e.vic.sv) or (!e.att.sv and !e.vic.sv and !e.att.tr and !e.vic.tr) then
                     return wrong_icon, "Teamkill"
                  elseif e.att.tr or e.att.sv then
                     return right_icon, "Traitor killed innocent"
                  elseif !e.att.tr and !e.att.sv then
